...
let publishToNostr = process.env.PUBLISH_TO_NOSTR === "true" ? true : false || false;
...
if (publishToNostr) {
    ...
    const filter = { kinds: [1, 5], authors: ["642317135fd4c4205323b9dea8af3270657e62d51dc31a657c0ec8aab31c6288"] };
    let lastEventId = "";
...
let createPriceWebSocket = () => {
    ...
    ws.on('message', async (message) => {
        ...
        let currentDate = Date.now();
        if (currentDate / 1000 - lastPublish < 15)
            return;
